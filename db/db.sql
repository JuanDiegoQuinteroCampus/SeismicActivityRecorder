...
VALUES
  ...
  ('María', 'Gómez', 'maria@example.com', 9876543210, 2),
  ('Pedro', 'López', 'pedro@example.com', 5555555555, 3);
...
INSERT INTO usuario (nombre, apellido, correo, telefono, idLocalizacion)
VALUES
  ('Ana', 'Sánchez', 'ana@example.com', 1111111111, 1),
  ('Carlos', 'González', 'carlos@example.com', 2222222222, 2),
  ('Sofía', 'Martínez', 'sofia@example.com', 3333333333, 3);
...
INSERT INTO usuario (nombre, apellido, correo, telefono, idLocalizacion)
VALUES
  ('Luis', 'Ramírez', 'luis@example.com', 4444444444, 4),
  ('Marta', 'López', 'marta@example.com', 5555555555, 5),
  ('Jorge', 'Hernández', 'jorge@example.com', 6666666666, 6);
